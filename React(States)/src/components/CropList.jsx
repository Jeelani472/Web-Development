          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-2xl font-bold text-black mb-4 text-center">Region-wise Distribution</h3>
              ...
              {/* Pie Chart */}
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-2xl font-bold text-black mb-4 text-center">Crop Analytics</h3>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
                      data={chartData}
